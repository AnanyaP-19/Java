class BuyRunner
{
	public static void main(String[] args)
	{
		...
		Buy.product("Lee",1500);
		Buy.product("Lee",100000);
		Buy.product("AsianPaint",10,"Premium",1500);
		Buy.product("AsianPaint",9,"Premium",1500);
		Buy.bookMovieTicket("kalki","bharat cinema",51,5000);
		Buy.bookMovieTicket("kalki","bharat cinema",101,5000);
		Buy.buyEgg(12,6);
		Buy.buyEgg(12,21);
		Buy.buyShampoo(200,200,"Dove","jun20");
		Buy.buyShampoo(100,250,"Dove","jun20");
